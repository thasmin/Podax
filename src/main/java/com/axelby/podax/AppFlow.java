...
public class AppFlow {
	...
	public static AppFlow get(Context context) {
		return ((PodaxApplication)context.getApplicationContext()).getFlow();
	}
	...
	WeakReference<MainActivity> _mainActivity;
	...
	private Map<Integer, ScreenChange> _mainMenuMap = new HashMap<>(12);
	...
	public boolean onRequestViewReleaseNotes() {
		_app.startActivity(PodaxFragmentActivity.createIntent(_app, AboutFragment.class, null));
		return true;
	}

	private class LifecycleCallbackHandler implements Application.ActivityLifecycleCallbacks {
		@Override
