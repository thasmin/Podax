...
public class WatchedFragment extends SherlockFragment {

	private PodcastListFragment _podcastListFragment = null;
	private WatchedListFragment _watchedListFragment = null;
	...
	public void onDestroyView() {
		try {
			...
			ft.remove(_watchedListFragment);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		_watchedListFragment = new WatchedListFragment();
		ft.replace(R.id.subscriptionlist_fragment, _watchedListFragment, "watchedlist");
