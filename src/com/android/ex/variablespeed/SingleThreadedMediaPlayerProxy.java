...
public class SingleThreadedMediaPlayerProxy implements MediaPlayerProxy {
	...
	@Override
	public synchronized void prepareAsync() throws IOException {
		mDelegate.prepareAsync();
	}

	@Override
	public synchronized void setOnPreparedListener(MediaPlayer.OnPreparedListener listener) {
		mDelegate.setOnPreparedListener(listener);
	}
